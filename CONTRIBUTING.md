...
- If the package is at version `0.x.y` (pre-1.0), use `<1` (or `<0.next_minor` for particularly volatile APIs).
- For micro-version packages (e.g. `0.20.x`), `<1` is still appropriate.
